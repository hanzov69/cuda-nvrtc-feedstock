...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/cuda-nvrtc-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/cuda-nvrtc-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add cuda-nvrtc cuda-nvrtc-dev cuda-nvrtc-static
# for installing globally
pixi global install cuda-nvrtc cuda-nvrtc-dev cuda-nvrtc-static
```
...
It is possible to list all of the versions of `cuda-nvrtc` available on your platform:
...
```
pixi search cuda-nvrtc --channel conda-forge
```
